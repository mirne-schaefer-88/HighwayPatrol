...
class HPatrolVortexStack(Stack):
    ...
    def __init__(self,
        ...
        **kwargs) -> None:
        ...
        self._createIr141Lambda("141ir")


    def _createIr141Lambda(self, buildDir) -> str:
        theLambda = PythonFunction(self, "ir141Lambda",
            ...
            function_name=self.baseStackName + "_ir141",
            memory_size=1024,
        ...
        logger.info("ir141 lambda defined")
