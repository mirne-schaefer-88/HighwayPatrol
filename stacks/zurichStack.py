...
class HPatrolZurichStack(Stack):
    ...
    def __init__(self,
        ...
        **kwargs) -> None:
        ...
        generators = ["bazaNet", "customsGovBy"]
        csf.createLambdasStructure(self, gensDir, generators, executionMode)

        # self._createBazaNetLambda("bazaNet")   2026.03.01 Bazanet requesting registration :-(
        self._createCustomsGovByLambda("customsGovBy")


    def _createCustomsGovByLambda(self, buildDir) -> str:
        theLambda = PythonFunction(self, "customsGovByLambda",
            description="Collects and parses CustomsGovBy site to create aimpoints",
            ...
            function_name=self.baseStackName + "_CustomsGovBy",
            memory_size=1024,
        ...
        logger.info("CustomsGovBy lambda defined")
    ...
    def _createBazaNetLambda(self, buildDir) -> str:
